...
20121015
originally nucRimMeasure.ijm, extended for including all the measurements and plottings. 
'''
...
# reject edge touching paths, mark the path so that it will not be analyzed. 
...
def segmentNuc(impc2, G_RimHalfWidth):
